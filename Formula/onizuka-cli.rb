class OnizukaCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Biolevate/homebrew-tap/releases/download/cli-v1.0.4/ozk-darwin-arm64.tar.gz"
      sha256 "a664a6b5780e25e8dda46a5df562ae348754cc06c30978648a0047770da5d632"
    else
      url "https://github.com/Biolevate/homebrew-tap/releases/download/cli-v1.0.4/ozk-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Biolevate/homebrew-tap/releases/download/cli-v1.0.4/ozk-linux-arm64.tar.gz"
      sha256 "ab280b65a48f2312c6ec4913d3128648280834a9c82526acdb02aad350f51269"
    else
      url "https://github.com/Biolevate/homebrew-tap/releases/download/cli-v1.0.4/ozk-linux-amd64.tar.gz"
